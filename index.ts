...
async function textWrite (text:string) {
...
class Customer {
    ...
    balance : number
    constructor(fName: string, lName: string, age: number, gender: string, accountNo: number, balance : number) {
...
const customers: { [accountNo: number]: Customer } = {};
...
async function CreateAccount() {
    ...
    const account : any = generateAccountNumber();
